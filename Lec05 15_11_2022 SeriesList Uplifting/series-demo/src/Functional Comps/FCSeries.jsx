...
export default function FCSeries(props) {
  return (
    <div className="list-group-item">
      ...
      | {props.genre} | {props.seasons} | <span style={{ color: 'red' }}> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-shield-x" viewBox="0 0 16 16">
